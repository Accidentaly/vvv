...
class _Inscription2State extends State<Inscription2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      .document()
      .setData({
         'societe assurance':_societecontroller.text ,
        'num attestation':_attescontroller.text ,
        'date attribution ':_dateatrController.text ,
        'date expiration':_datexcontroller.text ,
